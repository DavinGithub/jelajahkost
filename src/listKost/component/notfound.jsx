...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="w-full flex flex-col lg:flex-row">
            ...
            <div class="hidden w-full lg:flex lg:pl-11 max-lg:mt-1 max-lg:overflow-y-auto" id="navbar">
              <ul class="flex lg:items-center lg:justify-center flex-col lg:gap-6 gap-4 max-lg:pt-4 max-lg:mb-4 lg:mt-0 lg:flex-row lg:mx-auto ">
                <li>
                  <a href="javascript:;" class="nav-link block lg:px-2 lg:text-left text-base text-gray-900 font-medium transition-all duration-500 hover:text-gray-500">Home</a>
                </li>
                <li>
                  <a href="javascript:;" class="nav-link block lg:px-2 lg:text-left text-gray-900 text-base font-medium transition-all duration-500 hover:text-gray-500">About
                    us</a>
                </li>
                <li class="relative">
    ...
    <footer class="w-full border-t border-gray-200">
        ...
        <div class="flex items-center justify-between w-full max-w-xl mx-auto flex-col  2xl:flex-col 2xl:items-start">
          <p class="2xl:py-8 py-4 text-sm text-gray-500 2xl:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ?</p>
          <a href="javascript:;" class="py-2 px-5 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0"> Contact us </a>
        </div>
        </div>
        ...
        <ul class="text-sm  transition-all duration-500 ">
          <li class="mb-6">
            <a href="javascript:;" class="text-gray-600 text-sm font-normal hover:text-gray-900">Home</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">About</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Pricing</a>
          </li>
          <li>
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Features</a>
          </li>
        </ul>
        </div>
        ...
        <ul class="text-sm  transition-all duration-500">
          <li class="mb-6">
            <a href="javascript:;" class="text-gray-600 text-sm font-normal hover:text-gray-900">Figma UI System</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Icons Assets</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Responsive Blocks</a>
          </li>
          <li>
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Components Library</a>
          </li>
        </ul>
        </div>
        ...
        <ul class="text-sm  transition-all duration-500">
          <li class="mb-6">
            <a href="javascript:;" class="text-gray-600 text-sm font-normal hover:text-gray-900">FAQs</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Quick Start</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Documentation</a>
          </li>
          <li>
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">User Guide</a>
          </li>
        </ul>
        </div>
        ...
        <ul class="text-sm  transition-all duration-500">
          <li class="mb-6">
            <a href="javascript:;" class="text-gray-600 text-sm font-normal hover:text-gray-900">News</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Tips & Tricks</a>
          </li>
          <li class="mb-6">
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">New Updates</a>
          </li>
          <li>
            <a href="javascript:;" class=" text-gray-600 text-sm font-normal hover:text-gray-900">Events</a>
          </li>
        </ul>
        </div>
        </div>
